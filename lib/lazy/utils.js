  ...
  bower: {
    ...
    getMain: function(asset) {
      ...
      if (files.length === 0) {
        ...
        var found, patterns = [
          dependency_root + '/' + asset.href + '.js',
          dependency_root + '/' + asset.href + '.min.js',
          dependency_root + '/jquery.' + asset.href + '.js',
          dependency_root + '/jquery.' + asset.href + '.min.js',
          dependency_root + '/{dist,build}/' + asset.href + '.js',
          dependency_root + '/{dist,build}/' + asset.href + '.min.js',
          dependency_root + '/{dist,build}/jquery.' + asset.href + '.js',
          dependency_root + '/{dist,build}/jquery.' + asset.href + '.min.js',
        ];
